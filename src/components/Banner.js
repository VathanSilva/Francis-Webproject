              ...
              <TrackVisibility>
                ...
                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                  ...
                  <h1>{`Hi! I'm Francis.`} <div><span className="txt-rotate" dataPeriod="1000" data-rotate='[ "UI/UX Designer", "FrontEnd Developer", "BackEnd Developer" ]'><span className="wrap">{text}</span></span></div></h1>
                    <p>Hi! I’m an enthusiastic individual presently seeking the role of intern or associate in the IT and electronics sectors. My primary interest lies in software engineering and graphic design. Being a self-motivated, fast learner, I can multitask and handle responsibilities from different job roles elegantly. I also consider myself a person with strong communication skills, both orally and in written form. Thus, I actively engage in teamwork and am willing to contribute my best to any task. Now I am an Electronic Embedded System student at the University of Sri Jayawardenapura.</p>
